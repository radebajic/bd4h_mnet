...
class ExperimentPlanner3D_v21_trgSp_z1p0_yx0p9121_sg_vmamba(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super().__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_trgSp_z1p0_yx0p9121_sg_vmamba"
    ...
    def get_target_spacing(self):
        return np.array([1.0, 0.9121, 0.9121])
