...
class ExperimentPlanner3D_v21_trgSp_z4p0_yx0p9121_baseline(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super().__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1_trgSp_z4p0_yx0p9121_baseline"
